...
async function mainStdio() {
    ...
    console.error("[Init] GZH MCP server started successfully and listening for requests...");
}
...
async function main() {
    ...
    if (isClientMode) {
        ...
        console.error("[Init] Starting GZH MCP server in remote client mode...");
        ...
        console.error("[Init] Starting GZH MCP server in local mode...");
    }
